...
mod tests {
    ...
    fn test_username_reuse_after_change() {
        ...
        assert!(
            !dispatcher.is_username_taken(original_username),
            "Original username should be available",
        );
    ...
    fn test_mapping_consistency_after_username_change() {
        ...
        assert!(
            dispatcher.get_address_by_username(old_username) == user,
            "Old username should map to user",
        );
        ...
        assert!(
            dispatcher.get_address_by_username(new_username) == user,
            "New username should map to user",
        );
        ...
        assert!(
            profile_by_addr.public_key == profile_by_username.public_key,
    ...
    fn test_is_user_registered_consistency() {
        ...
        assert!(
            !dispatcher.is_user_registered(unregistered_user),
        ...
        assert!(
            dispatcher.is_user_registered(user), "User should be registered after registration",
        );
